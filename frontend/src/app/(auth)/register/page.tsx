...
import { ArrowRight, Lock, Mail, Eye, EyeOff, Briefcase, User, Phone, Paperclip, ScrollText } from "lucide-react";
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm opacity-70">
            Create your account to start a new jourey
          </p>
        </div>
          ...
          <form onSubmit={submitHandler} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                <Briefcase className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-600 dark:text-gray-200" />
                <select
                  id="role"
                  value={role}
            ...
            {role && (
              <div className="space-y-5 animate-in fade-in duration-300">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-600 dark:text-gray-200" />
                    <Input
                      id="name"
                      type="name"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Phone className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-600 dark:text-gray-200" />
                    <Input
                      id="phone"
                      type="number"
                ...
                {role === "jobseeker" && <div className="space-y-5 pt-4 border-t border-gray-400">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Paperclip className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-600 dark:text-gray-200" />
                      <Input
                        id="resume"
                        type="file"
                        ...
                        required
                        className="cursor-pointer h-11 rounded-md border border-gray-400 bg-transparent pl-10 pr-3 text-sm 
                        focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:text-gray-200"
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <ScrollText className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-600 dark:text-gray-200" />
                      <Input
                        id="bio"
                        type="text"
