...
const JobPage = () => {
  ...
  useEffect(() => {
    if (user && user.user_id === job?.posted_by_recuriter_id) {
            ...
            <Card className="overflow-hidden shadow-lg border-2 mb-6">
              ...
              <div className="p-8">
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                  {/* Location Card */}
                  <div className="flex items-center gap-4 p-5 rounded-xl border bg-background shadow-sm">
                    {/* Icon */}
                ...
                <div className="space-y-4">
                  <h2 className="text-2xl font-bold flex items-center gap-2">
                    <Briefcase size={24} className="text-blue-600" /> Job
                    Description
                  </h2>
          ...
          <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="p-2 border-2 border-gray-2 rounded-md bg-background"
              >
