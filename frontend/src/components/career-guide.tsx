                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {skills.map((s) => (
                          <div
                            key={s}
                            className="inline-flex items-center gap-2 pl-3 pr-2 py-1.5 rounded-full bg-blue-100 dark:bg-blue-900/30 border border-blue-200 dark:border-bluw-800"
                          >
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {response.skillsToLearn.map((category, index) => (
                        <React.Fragment key={category.category ?? index}>
                          <div className="space-y-2">
                          ...
                          <div className="space-y-2">
                            {category.skills.map((skill, sindex) => (
                              <div
                                key={`${category.category}-${skill.title}-${sindex}`}
